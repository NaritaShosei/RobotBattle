...
public class LockOn : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        foreach (var enemy in _enemies)
        {
            ...
            var playerForward = _player.transform.forward.normalized;
            ...
            Vector3 playerFlatForward = new Vector3(playerForward.x, 0, playerForward.z).normalized;

            float dotHorizontal = Vector3.Dot(playerFlatForward, enemyDirFlat);
            ...
            float forwardFlatDis = new Vector3(playerForward.x, 0, playerForward.z).magnitude;
            var verticalForward = new Vector3(0, playerForward.y, forwardFlatDis).normalized;
