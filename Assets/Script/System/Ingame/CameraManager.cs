...
public class CameraManager : MonoBehaviour
{
    ...
    void Look(InputAction.CallbackContext context)
    {
        ...
        _freeLookCamera.HorizontalAxis.Value += _velocity.x * _cameraSensitivity;
        _freeLookCamera.VerticalAxis.Value = Mathf.Clamp(
        _freeLookCamera.VerticalAxis.Value += _velocity.y * _cameraSensitivity,
